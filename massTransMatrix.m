...
[expNums{1:18}]    = deal([1:128]);
expNums{7} = [1:112]; expNums{10} = [1:64];
expNums{11} = [17:80]; expNums{12} = [17:80];
expNums{16} = [65:128]; expNums{17} = [65:128]; expNums{18} = [65:128];
genotypes  = {2,2,7,12,2,8,4,1,8,4,3,9,3,10,3,11,5,9};
NtoSample = 500;
