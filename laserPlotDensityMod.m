		...
		if isfield(exp,'trainingEpochs')
			if plotN == 1
				fill(2*[0 1 1 0] + xBins(end) + 1 + xOffset,...
				    -[.5 .5 1.5 1.5].*60 + yOffset,...
				    'g','FaceColor','g','EdgeColor','none','FaceAlpha',.5);
				fill(2*[-1 0 0 -1] + xBins(1) - 1 + xOffset,...
				    -[2 2 2.5 2.5].*60 + yOffset,...
				    'b','FaceColor','b','EdgeColor','none','FaceAlpha',.3);
			elseif plotN == 2
				fill(2*[0 -1 -1 0] + xBins(1) - 1 + xOffset,...
				    -[.5 .5 1.5 1.5].*60 + yOffset,...
				    'g','FaceColor','g','EdgeColor','none','FaceAlpha',.5);
				fill(2*[0 1 1 0] + xBins(end) + 1 + xOffset,...
				    -[2 2 2.5 2.5].*60 + yOffset,...
