function plotContingentMiesenbockShort(expNum)
		...
		for flyN = 1:8
			...
			fill([0 .5 .5 0]+1,[-25 -25 0 0]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','b',...
				'FaceAlpha',.2);
			fill([0 .5 .5 0]+5,[0 0 25 25]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','b',...
				'FaceAlpha',.2);
			fill([0 .5 .5 0] +9,[-25 -25 0 0]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','g',...
				'FaceAlpha',.2);
			fill([0 .5 .5 0]+11,[0 0 25 25]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','g',...
				'FaceAlpha',.2);
			fill([0 .5 .5 0]+14,[-25 -25 0 0]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','g',...
				'FaceAlpha',.2);
			fill([0 .5 .5 0]+16,[0 0 25 25]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','g',...
				'FaceAlpha',.2);
			fill([0 .5 .5 0]+22,[-25 -25 0 0]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','b',...
				'FaceAlpha',.2);
			fill([0 .5 .5 0]+26,[0 0 25 25]-spaceDist*flyN,'b','EdgeColor','none','FaceColor','b',...
				'FaceAlpha',.2);				
		end
